...
var cont = message.content.slice(prefix.length).split(" ");
  ...
  var args = cont.slice(1);
       if (message.content.startsWith("نيك")) {
...
client.on('message',async message => {
  ...
  if(message.content.startsWith( p + "botn")) {
...
message.channel.sendFile("وعليكم السلام ورحمة الله وبركاته ,منور ء");
 }
});
...
if(message.author.bot) return;
if (message.content === '.') {
message.channel.sendFile("آطٌلَقَ مِنٌ يّنٌقَطٌ, وللكم , ء منور");
}
});
...
if (message.content === 'باك') {
 message.channel.sendFile("ولـكم ء , آطلق من جآنا");
 }
 });
...
message.channel.send("**#Welcome To City Owners...:tada::tada:**")
}
});
...
if (message.content === 'برب') {
 message.channel.sendFile(", :wink: :eight_pointed_black_star:تيت الله معك يحلو لا تطول علينا :eight_pointed_black_star: :wink:.!");
 }
 });
